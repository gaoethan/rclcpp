  ...
  std::shared_ptr<Alloc> allocator)
{
  ...
  auto message_alloc =
    std::make_shared<
      typename subscription::Subscription<CallbackMessageT, Alloc>::MessageAlloc>();
  ...
  factory.setup_intra_process =
    ...
    const rcl_subscription_options_t & subscription_options)
    {
      ...
      auto take_intra_process_message_func =
        ...
        typename rclcpp::subscription::Subscription<CallbackMessageT, Alloc>::MessageUniquePtr & message)
        {
